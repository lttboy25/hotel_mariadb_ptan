    ...
    -- 5. CA LÀM VIỆC (Ca)
    -- ========================================
    -- Schema mới: tenCa, gioBatDau, gioKetThuc, moTa
    -- Ca là khái niệm hàng ngày (Ca sáng, Ca chiều, Ca tối)
    INSERT INTO cas (maCa, tenCa, gioBatDau, gioKetThuc, moTa)
    VALUES
        ('CA001', 'Ca 1', '07:00:00', '12:00:00', N'Ca sáng'),
        ('CA002', 'Ca 2', '12:00:00', '18:00:00', N'Ca chiều'),
        ('CA003', 'Ca 3', '18:00:00', '23:00:00', N'Ca tối'),
        ('CA004', 'Ca 4', '23:00:00', '07:00:00', N'Ca đêm');
    ...
    -- 4 Ca làm việc (Ca 1, Ca 2, Ca 3, Ca 4 đêm) ✅ CẬP NHẬT
    -- 6 Ca làm việc nhân viên đang hoạt động
    -- 10 Khách hàng
    -- 13 Khuyến mãi (7 đang áp dụng, 3 kết thúc, 3 chưa áp dụng) ✅ CẬP NHẬT
