...
public class QuanLyKhuyenMaiPanel extends JPanel {
    ...
    private java.util.List<KhuyenMaiDTO> getCurrentData() {
        ...
        if (keyword.isBlank()) {
            return khuyenMaiServiceImpl.getAllKhuyenMai();
        }
        return khuyenMaiServiceImpl.searchKhuyenMai(keyword);
    }
...
class KhuyenMaiModal extends JDialog {
    ...
    KhuyenMaiModal(JFrame owner, KhuyenMaiDTO khuyenMai, boolean isNew, Runnable onChanged) {
        ...
        this.autoGeneratedCode = isNew ? khuyenMaiServiceImpl.generateNextMaKhuyenMai() : this.current.getMaKhuyenMai();
    ...
    private void onSave() {
        try {
            ...
            khuyenMaiServiceImpl.addKhuyenMaiAutoCode(km);
    ...
    private void onUpdate() {
        try {
            KhuyenMaiDTO km = collectFormData();
            khuyenMaiServiceImpl.updateKhuyenMai(km);
    ...
    private void onDelete() {
        ...
        try {
            khuyenMaiServiceImpl.deleteKhuyenMai(tfMa.getText().trim());
