...
public class VictoryaDashboard extends JFrame {
    ...
    public VictoryaDashboard() {
        ...
        contentCards.add(new GiaHanPhongPanel(), "giahan");
    ...
    private JPanel buildSidebar() {
        ...
        sidebar.add(navRow(NavIcon.NHAN_VIEN, "Quản lý Khách hàng", 0, false, "quanlykhachhang"));
        ...
        sidebar.add(navRow(NavIcon.THANH_TOAN, "Thanh Toán", 0, false, "thanhtoan"));
    ...
    private JPanel buildPhongGroup(JPanel sidebar) {
        ...
        Object[][] children = {
                ...
                { NavIcon.GIA_HAN, "Gia Hạn Phòng", "giahan" },
        ...
        MouseAdapter toggle = new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                if (!parentActive[0]) {
                    parentRow.setBackground(new Color(0xF4F7FF));
                    parentRow.repaint();
                }
            }
...
class NavIcon {
    ...
    static final int THANH_TOAN = 14;
}
    ...
    protected void paintComponent(Graphics g) {
        ...
        switch (type) {
            ...
            case NavIcon.THONG_KE -> {
                ...
                g2.drawArc(cx - (int) (r * 0.42f), cy - (int) (r * 0.56f), (int) (r * 0.84f), (int) (r * 0.58f), 0,
                        200);
                g2.drawArc(cx - (int) (r * 0.42f), cy - (int) (r * 0.06f), (int) (r * 0.84f), (int) (r * 0.58f), 180,
                        200);
            }
            case NavIcon.DICH_VU -> {
                ...
                g2.drawLine(cx - (int) (r * 0.3f), cy - (int) (r * 0.55f), cx + (int) (r * 0.7f),
                        cy + (int) (r * 0.35f));
            }
