...
public class QuanLyKhachHangPanel extends JPanel {
    ...
    private JPanel buildToolbar() {
        ...
        JButton btnRefresh = QuanLyNhanVienPanel.createButton("Làm mới", new Color(0xEEF0F5), new Color(0xDDE0E8),
                TEXT_MID, 100, 38);
    ...
    class KhachHangModal extends JDialog {
        ...
        private JPanel buildFooter() {
            ...
            JButton cancel = QuanLyNhanVienPanel.createButton("Hủy", new Color(0xEEF0F5), new Color(0xDDE0E8), TEXT_MID,
                    80, 38);
            cancel.addActionListener(e -> dispose());

            JButton del = QuanLyNhanVienPanel.createButton("Xóa", RED, RED.darker(), Color.WHITE, 80, 38);
            del.addActionListener(e -> {
                int confirm = JOptionPane.showConfirmDialog(this, "Xóa khách hàng " + tfMa.getText() + "?", "Xác nhận",
                ...
                try {
                    if (hasValidRequiredFields()) {
                        KhachHangDTO kh = KhachHangDTO.builder()
                                ...
                                .ngayTao(rowData != null && rowData.getNgayTao() != null ? rowData.getNgayTao()
                                        : LocalDate.now())
                                .build();
