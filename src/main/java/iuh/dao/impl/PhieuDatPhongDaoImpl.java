...
public class PhieuDatPhongDaoImpl extends AbstractGenericDaoImpl<PhieuDatPhong, String> implements iuh.dao.PhieuDatPhongDao {

    public PhieuDatPhongDaoImpl() {super(PhieuDatPhong.class);}
